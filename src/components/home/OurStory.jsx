          ...
          <div className="space-y-8">
            ...
            >
              ...
              >
                לכידת נצח
                <br />
                <span className="text-[#d4af37]">בכל פריים</span>
              </motion.h2>
            </motion.div>
            ...
            >
              ...
              >
                אנחנו לימור ויעקב, צמד צלמים שמסעם בעולם הצילום התחיל לפני למעלה מעשרים שנה. 
                מאז, נדדנו לקצוות העולם כדי לתפוס את הרגעים הבלתי נשכחים ביותר של הטבע הפראי.
              </motion.p>
              ...
              <motion.p
                ...
                className="text-[#a8a8a8] text-lg leading-relaxed"
              >
                מהערבות האפריקאיות ועד היערות הגשם של דרום אמריקה, מהשבטים המרוחקים ועד הנופים 
                הדרמטיים ביותר - כל תמונה מספרת סיפור של רגע מושלם, של אור מיוחד, של קשר עמוק עם הטבע.
              </motion.p>
              ...
              <motion.p
                ...
                className="text-[#a8a8a8] text-lg leading-relaxed"
              >
                היצירות שלנו מודפסות על קנבסים איכותיים ביותר, עם תשומת לב לכל פרט - 
                כי אנחנו מאמינים שיצירות אמנות ראויות להופיע בבית שלכם בדיוק כפי שראינו אותן דרך העדשה.
              </motion.p>
            </motion.div>
